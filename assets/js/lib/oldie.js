...
(function (l) { "object" === typeof module && module.exports ? module.exports = l : l(Highcharts); })(function (l) {
    (function (d) {
        var w, g;
        g = d.Chart;
        var A = d.createElement, l = d.css, E = d.defined, n = d.deg2rad, F = d.discardElement, h = d.doc, I = d.each, G = d.erase, B = d.extend;
        w = d.extendClass;
        var M = d.isArray, K = d.isNumber, C = d.isObject, N = d.merge, L = d.noop, x = d.pick, t = d.pInt, D = d.svg, y = d.SVGElement, u = d.SVGRenderer, v = d.win, O = d.wrap;
        d.getOptions().global.VMLRadialGradientURL = "http://code.highcharts.com/6.0.5/gfx/vml-radial-gradient.png";
        h &&
            !h.defaultView && (d.getStyle = function (a, b) { var c = { width: "clientWidth", height: "clientHeight" }[b]; if (a.style[b])
            return d.pInt(a.style[b]); "opacity" === b && (b = "filter"); if (c)
            return a.style.zoom = 1, Math.max(a[c] - 2 * d.getStyle(a, "padding"), 0); a = a.currentStyle[b.replace(/\-(\w)/g, function (a, b) { return b.toUpperCase(); })]; "filter" === b && (a = a.replace(/alpha\(opacity=([0-9]+)\)/, function (a, b) { return b / 100; })); return "" === a ? 1 : d.pInt(a); });
        ...
        Array.prototype.indexOf || (d.indexOfPolyfill = function (a) { var b, c = 0; if (a)
            for (b = a.length; c < b; c++)
                if (a[c] === this)
                    return c; return -1; });
        Array.prototype.filter || (d.filterPolyfill = function (a) { for (var b = [], c = 0, e = this.length; c < e; c++)
            a(this[c], c) && b.push(this[c]); return b; });
        Object.prototype.keys || (d.keysPolyfill = function (a) { var b = [], c = Object.prototype.hasOwnProperty, e; for (e in a)
            c.call(a, e) && b.push(e); return b; });
        Array.prototype.reduce || (d.reducePolyfill = function (a, b) { b = b || {}; for (var c = this.length, e = 0; e < c; ++e)
            b = a.call(this, b, this[e], e, this); return b; });
        D || (O(d.SVGRenderer.prototype, "text", function (a) { return a.apply(this, Array.prototype.slice.call(arguments, 1)).css({ position: "absolute" }); }), d.Pointer.prototype.normalize = function (a, b) { a = a || v.event; a.target || (a.target = a.srcElement); b || (this.chartPosition = b = d.offset(this.chart.container)); return d.extend(a, { chartX: Math.round(Math.max(a.x, a.clientX - b.left)), chartY: Math.round(a.y) }); }, g.prototype.ieSanitizeSVG = function (a) {
            ...
            function (a, b) { this.detachEvent && (b = this.hcEventsIE[b.hcKey], this.detachEvent("on" + a, b)); }, g = { docMode8: h && 8 === h.documentMode, init: function (a, b) { var c = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'], e = ["position: ", "absolute", ";"], d = "div" === b; ("shape" === b || d) && e.push("left:0;top:0;width:1px;height:1px;"); e.push("visibility: ", d ? "hidden" : "visible"); c.push(' style\x3d"', e.join(""), '"/\x3e'); b && (c = d || "span" === b || "img" === b ? c.join("") : a.prepVML(c), this.element = A(c)); this.renderer = a; }, add: function (a) {
                var b = this.renderer, c = this.element, e = b.box, d = a && a.inverted, e = a ? a.element || a : e;
                ...
                l(this.element, { filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11\x3d", b, ", M12\x3d",
            ...
            }, on: function (a, b) { this.element["on" + a] = function () { var a = v.event; a.target = a.srcElement; b(a); }; return this; }, cutOffPath: function (a, b) { var c; a = a.split(/[ ,]/); c = a.length; if (9 === c || 11 === c)
                a[c - 4] = a[c - 2] = t(a[c - 2]) - 10 * b; return a.join(" "); }, shadow: function (a, b, c) {
                var e = [], d, f = this.element, h = this.renderer, q, g = f.style, k, r = f.path, J, m, l, n;
            ...
            }, zIndexSetter: function (a, b, c) { c.style[b] = a; } }, g["stroke-opacitySetter"] = g["fill-opacitySetter"], d.VMLElement = g = w(y, g), g.prototype.ySetter = g.prototype.widthSetter = g.prototype.heightSetter = g.prototype.xSetter, g = { Element: g, isIE8: -1 < v.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a, b, c) {
                var e, d;
                this.alignedObjects = [];
            ...
            clipRect: function (a, b, c, e) {
                var d = this.createElement(), f = C(a);
                return B(d, { members: [], count: 0, left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : e) - 1, getCSS: function (a) { var b = a.element, c = b.nodeName, e = a.inverted, d = this.top - ("shape" === c ? b.offsetTop : 0), f = this.left, b = f + this.width, p = d + this.height, d = { clip: "rect(" + Math.round(e ? f : d) + "px," + Math.round(e ? p : b) + "px," + Math.round(e ? b : p) + "px," + Math.round(e ? d : f) + "px)" }; !e && a.docMode8 && "DIV" === c && B(d, { width: b + "px", height: p + "px" }); return d; }, updateClipping: function () {
                        I(d.members, function (a) { a.element && a.css(d.getCSS(a)); });
                    } });
            }, color: function (a, b, c, e) {
                var p = this, f, h = /^rgba/, q, g, k = "none";
                a && a.linearGradient ? g = "gradient" : a && a.radialGradient && (g = "pattern");
                if (g) {
                    var r, l, m = a.linearGradient || a.radialGradient, n, t, u, v, w, x = "";
                    a = a.stops;
                    var y, B = [], C = function () { q = ['\x3cfill colors\x3d"' + B.join(",") + '" opacity\x3d"', u, '" o:opacity2\x3d"', t, '" type\x3d"', g, '" ', x, 'focus\x3d"100%" method\x3d"any" /\x3e']; A(p.prepVML(q), null, null, b); };
                    n = a[0];
                    y = a[a.length - 1];
                    0 < n[0] && a.unshift([0, n[1]]);
                    1 >
                        y[0] && a.push([1, y[1]]);
                    I(a, function (a, b) { h.test(a[1]) ? (f = d.color(a[1]), r = f.get("rgb"), l = f.get("a")) : (r = a[1], l = 1); B.push(100 * a[0] + "% " + r); b ? (u = l, v = r) : (t = l, w = r); });
                    if ("fill" === c)
                        if ("gradient" === g)
                            c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle\x3d"' + (90 - 180 * Math.atan((m - a) / (n - c)) / Math.PI) + '"', C();
                        else {
                            var k = m.r, D = 2 * k, E = 2 * k, F = m.cx, G = m.cy, H = b.radialReference, z, k = function () {
                                ...
                                x =
                                    'src\x3d"' + d.getOptions().global.VMLRadialGradientURL + '" size\x3d"' + D + "," + E + '" origin\x3d"0.5,0.5" position\x3d"' + F + "," + G + '" color2\x3d"' + w + '" ';
                                C();
                            };
                            e.added ? k() : e.onAdd = k;
                            k = v;
                    ...
                    h.test(a) && "IMG" !== b.tagName ? (f = d.color(a), e[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb")) : (k = b.getElementsByTagName(c), k.length && (k[0].opacity = 1, k[0].type = "solid"), k = a);
                return k;
            }, prepVML: function (a) {
                var b = this.isIE8;
                a = a.join("");
                ...
                l(a, { flip: "x", left: t(b.width) - (e ? t(e.top) : 1), top: t(b.height) - (e ? t(e.left) : 1), rotation: -90 });
                I(a.childNodes, function (b) { c.invertChild(b, a); });
            }, symbols: { arc: function (a, b, c, e, d) { var f = d.start, h = d.end, g = d.r || c || e; c = d.innerR; e = Math.cos(f); var p = Math.sin(f), k = Math.cos(h), l = Math.sin(h); if (0 === h - f)
                    return ["x"]; f = ["wa", a - g, b - g, a + g, b + g, a + g * e, b + g * p, a + g * k, b + g * l]; d.open && !c && f.push("e", "M", a, b); f.push("at", a - c, b - c, a + c, b + c, a + c * k, b + c * l, a + c * e, b + c * p, "x", "e"); f.isArc = !0; return f; }, circle: function (a, b, c, e, d) { d && E(d.r) && (c = e = 2 * d.r); d && d.isCircle && (a -= c / 2, b -= e / 2); return ["wa", a, b, a + c, b + e, a + c, b + e / 2, a + c, b + e / 2, "e"]; },
                rect: function (a, b, c, d, g) { return u.prototype.symbols[E(g) && g.r ? "callout" : "square"].call(0, a, b, c, d, g); } } }, d.VMLRenderer = w = function () { this.init.apply(this, arguments); }, w.prototype = N(u.prototype, g), d.Renderer = w);
        u.prototype.getSpanWidth = function (a, b) { var c = a.getBBox(!0).width; !D && this.forExport && (c = this.measureSpanWidth(b.firstChild.data, a.styles)); return c; };

(function (a) { if (typeof define === "function" && define.amd) {
    ...
    if (!("indexOf" in Array.prototype)) {
        Array.prototype.indexOf = function (k, j) { if (j === f) {
            j = 0;
        } if (j < 0) {
            j += this.length;
        } if (j < 0) {
    ...
    var g = function (k, j) {
        ...
        this._attachEvents();
        this.clickedOutside = function (n) { if (d(n.target).closest(".datetimepicker").length === 0) {
            m.hide();
        } };
        ...
        this.onRenderDay = function (n) { var p = (j.onRenderDay || function () { return []; })(n); if (typeof p === "string") {
            p = [p];
        } var o = ["day"]; return o.concat((p ? p : [])); };
        this.onRenderHour = function (n) { var p = (j.onRenderHour || function () { return []; })(n); var o = ["hour"]; if (typeof p === "string") {
            p = [p];
        } return o.concat((p ? p : [])); };
        this.onRenderMinute = function (n) { var p = (j.onRenderMinute || function () { return []; })(n); var o = ["minute"]; if (typeof p === "string") {
            p = [p];
        ...
        this.onRenderYear = function (o) { var q = (j.onRenderYear || function () { return []; })(o); var p = ["year"]; if (typeof q === "string") {
            q = [q];
        ...
        this.onRenderMonth = function (n) { var p = (j.onRenderMonth || function () { return []; })(n); var o = ["month"]; if (typeof p === "string") {
            p = [p];
        } return o.concat((p ? p : [])); };
    ...
    g.prototype = { constructor: g, _events: [], _attachEvents: function () {
        ...
        }, getDate: function () { var i = this.getUTCDate(); if (i === null) {
            return null;
        } return new Date(i.getTime() + (i.getTimezoneOffset() * 60000)); }, getUTCDate: function () { return this.date; }, getInitialDate: function () { return this.initialDate; }, setInitialDate: function (i) { this.initialDate = i; }, setDate: function (i) { this.setUTCDate(new Date(i.getTime() - (i.getTimezoneOffset() * 60000))); }, setUTCDate: function (i) {
        ...
        }, setFormat: function (j) { this.format = c.parseFormat(j, this.formatType); var i; if (this.isInput) {
            i = this.element;
        }
        else {
            if (this.component) {
        ...
        }, getFormattedDate: function (i) { i = i || this.format; return c.formatDate(this.date, i, this.language, this.formatType, this.timezone); }, setStartDate: function (i) {
            ...
            this.update();
            this.updateNavArrows();
        }, setTitle: function (i, j) { return this.picker.find(i).find("th:eq(1)").text(this.title === false ? j : this.title); }, setDaysOfWeekDisabled: function (i) {
            this.daysOfWeekDisabled = i || [];
            if (!d.isArray(this.daysOfWeekDisabled)) {
                this.daysOfWeekDisabled = this.daysOfWeekDisabled.split(/,\s*/);
            }
            this.daysOfWeekDisabled = d.map(this.daysOfWeekDisabled, function (j) { return parseInt(j, 10); });
            this.update();
            this.updateNavArrows();
            ...
            this.minutesDisabled = d.map(this.minutesDisabled, function (j) { return parseInt(j, 10); });
            this.update();
            this.updateNavArrows();
            ...
            this.hoursDisabled = d.map(this.hoursDisabled, function (j) { return parseInt(j, 10); });
            this.update();
            this.updateNavArrows();
        }, place: function () {
            if (this.isInline) {
            ...
            if (!this.zIndex) {
                var j = 0;
                d("div").each(function () { var o = parseInt(d(this).css("zIndex"), 10); if (o > j) {
                    j = o;
                } });
                this.zIndex = j + 10;
            }
            ...
            this.showMode(k);
            setTimeout(d.proxy(function () { this.wheelPause = false; }, this), this.wheelViewModeNavigationDelay);
        }, click: function (m) {
            m.stopPropagation();
            m.preventDefault();
            ...
            return n;
        }, moveYear: function (j, i) { return this.moveMonth(j, i * 12); }, dateWithinRange: function (i) { return i >= this.startDate && i <= this.endDate; }, keydown: function (o) {
            ...
            this.updateNavArrows();
        }, reset: function () { this._setDate(null, "date"); }, convertViewModeText: function (i) {
            switch (i) {
                case 4:
                    return "decade";
                case 3:
    ...
    var c = { modes: [{ clsName: "minutes", navFnc: "Hours", navStep: 1 }, { clsName: "hours", navFnc: "Date", navStep: 1 }, { clsName: "days", navFnc: "Month", navStep: 1 }, { clsName: "months", navFnc: "FullYear", navStep: 1 }, { clsName: "years", navFnc: "FullYear", navStep: 10 }], isLeapYear: function (i) { return (((i % 4 === 0) && (i % 100 !== 0)) || (i % 400 === 0)); }, getDaysInMonth: function (i, j) { return [31, (c.isLeapYear(i) ? 29 : 28), 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][j]; }, getDefaultFormat: function (i, j) { if (i === "standard") {
        ...
        } }, validParts: function (i) { if (i === "standard") {
            ...
            var q = A && A.toString().match(this.nonpunctuation) || [], A = new Date(0, 0, 0, 0, 0, 0, 0), m = {}, z = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P", "z", "Z"], o = { hh: function (s, i) { return s.setUTCHours(i); }, h: function (s, i) { return s.setUTCHours(i); }, HH: function (s, i) { return s.setUTCHours(i === 12 ? 0 : i); }, H: function (s, i) { return s.setUTCHours(i === 12 ? 0 : i); }, ii: function (s, i) { return s.setUTCMinutes(i); }, i: function (s, i) { return s.setUTCMinutes(i); }, ss: function (s, i) { return s.setUTCSeconds(i); }, s: function (s, i) { return s.setUTCSeconds(i); }, yyyy: function (s, i) { return s.setUTCFullYear(i); }, yy: function (s, i) { return s.setUTCFullYear(2000 + i); }, m: function (s, i) {
                    ...
                    return s;
                }, d: function (s, i) { return s.setUTCDate(i); }, p: function (s, i) { return s.setUTCHours(i === 1 ? s.getUTCHours() + 12 : s.getUTCHours()); }, z: function () { return r; } }, B, k, t;
            o.M = o.MM = o.mm = o.m;
            o.dd = o.d;
            o.P = o.p;
            o.Z = o.z;

        ...
        var _this = {
                    ...
                    change: function (options, skipped, target) {
                        ...
                        if (current) {
                            ...
                            for (i1 = 0; i1 < objects.length; i1++) {
                                if (objects[i1] instanceof fabric.Text ||
                                ...
                                else if (objects[i1] instanceof fabric.Path ||
            ...
            isTainted: function (source) {
                ...
                if (source) {
                    ...
                    if (origin.indexOf(":\\") != -1 || source.indexOf(":\\") != -1 ||
            ...
            gatherAttribute: function (elm, attr, limit, lvl) {
                var value, lvl = lvl ? lvl : 0, limit = limit ? limit : 3;
                if (elm) {
                                            ...
                                            g.paths[i1].set({
                                                clipTo: (function (i1, PID) {
                                                    return function (ctx) {
                                                        ...
                                                        if (_this.setup.chart.smoothCustomBullets !== undefined &&
            ...
            getAnnotations: function (options, callback) {
                var cfg = _this.deepMerge({}, options || {}, true);
                var i1;
                var data = [];
                // Collect annotations

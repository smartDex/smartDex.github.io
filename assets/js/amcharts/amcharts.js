(function () {
    ...
    d.Class = function (a) {
        ...
        a.inherits ? (b.prototype = new a.inherits(d.inheriting), b.base = a.inherits.prototype, delete a.inherits) :
            (b.prototype.createEvents = function () { for (var a = 0; a < arguments.length; a++)
...
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.titleWidth =
                0;
            this.periods = [{ period: "fff", count: 1 }, { period: "fff", count: 5 }, { period: "fff", count: 10 }, { period: "fff", count: 50 }, { period: "fff", count: 100 }, { period: "fff", count: 500 }, { period: "ss", count: 1 }, { period: "ss", count: 5 }, { period: "ss", count: 10 }, { period: "ss", count: 30 }, { period: "mm", count: 1 }, { period: "mm", count: 5 }, { period: "mm", count: 10 }, { period: "mm", count: 30 }, { period: "hh", count: 1 }, { period: "hh", count: 3 }, { period: "hh", count: 6 }, { period: "hh", count: 12 }, { period: "DD", count: 1 }, { period: "DD", count: 2 }, { period: "DD", count: 3 }, {
                    period: "DD",
                    count: 4
            ...
            this.dateFormats = [{ period: "fff", format: "NN:SS.QQQ" }, { period: "ss", format: "JJ:NN:SS" }, { period: "mm", format: "JJ:NN" }, { period: "hh", format: "JJ:NN" }, { period: "DD", format: "MMM DD" }, { period: "WW", format: "MMM DD" }, {
                    period: "MM",
                    format: "MMM"
        ...
        pushAxisItem: function (a, b) {
            ...
            if (e = a.getLabel())
                c.labelsSet.push(e), e.click(function (b) { c.handleMouse(b, a, "clickItem"); }).touchend(function (b) { c.handleMouse(b, a, "clickItem"); }).mouseover(function (b) {
                    c.handleMouse(b, a, "rollOverItem");
                }).mouseout(function (b) { c.handleMouse(b, a, "rollOutItem"); });
        },
...
(function () {
    ...
    d.AmChart = d.Class({
        ...
        drawChart: function () { 0 < this.realWidth && 0 < this.realHeight && (this.drawBackground(), this.redrawLabels(), this.drawTitles(), this.brr(), this.renderFix(), this.chart_container && (this.boundingRect = this.chart_container.getBoundingClientRect())); },
        ...
        initChart: function () {
            ...
            this.destroy();
            (a = this.container) ? (a.container.innerHTML = "", a.width = this.realWidth, a.height = this.realHeight, a.addDefs(this), this.chart_container.appendChild(a.container)) : a = new d.AmDraw(this.chart_container, this.realWidth, this.realHeight, this);
            this.container = a;
            this.extension = ".png";
        ...
        premeasure: function () {
            ...
            if (a) {
                try {
                    this.boundingRect = this.chart_container.getBoundingClientRect();
                }
                catch (e) { }
        ...
        measure: function () {
            var a = this.div;
            if (a) {
                var b = this.chart_container, c = a.offsetWidth, e = a.offsetHeight, g = this.container;
        ...
        clear: function (a) {
            ...
            this.clearTimeOuts();
            this.container &&
                (this.container.remove(this.chart_container), this.container.remove(this.legendDiv));
        ...
        setMouseCursor: function (a) {
            ...
            this.chart_container.style.cursor = a;
        ...
        updateHeight: function () {
            ...
            if (b) {
                ...
                if ("top" == b || "bottom" == b) {
                    ...
                    if (0 > a || isNaN(a))
                        a = 0;
                    this.chart_container.style.height = a + "px";
                }
            }
            return a;
        },
        updateWidth: function () {
            ...
            if (c) {
                ...
                c.ieW && (d = c.ieW);
                var f = e.offsetHeight, e = e.style, h = this.chart_container.style, k = c.position;
        ...
        handleDocTouchEnd: function () {
            -.5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy && this.tmy < this.divRealHeight ?
                (this.handleMouseMove(), 4 > Math.abs(this.mouseX - this.tmx) && 4 > Math.abs(this.mouseY - this.tmy) ? (this.tapped = !0, this.panRequired && this.panEventsEnabled && this.chart_container && (this.chart_container.style.msTouchAction = "none", this.chart_container.style.touchAction = "none")) : this.mouseIsOver || this.resetTouchStyle()) : (this.tapped = !1, this.resetTouchStyle());
        },
        resetTouchStyle: function () { this.panEventsEnabled && this.chart_container && (this.chart_container.style.msTouchAction = "auto", this.chart_container.style.touchAction = "auto"); },
        ...
        checkTouchMoved: function () { if (4 < Math.abs(this.mouseX - this.tmx) || 4 < Math.abs(this.mouseY - this.tmy))
            return !0; },
        addListeners: function () {
            var a = this, b = a.chart_container;
        ...
        brr: function () {
            if (!this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    ...
                    a.appendChild(e);
                    this.chart_container.appendChild(a);
                    this.amLink = a;
                    a = a.style;
                    a.position = "absolute";
...
(function () {
    ...
    d.AmGraph = d.Class({
        ...
        positionLabel: function (a, b, c, e, d) {
            if (e) {
                var f = this.chart, h = this.valueAxis, k = "middle", l = !1, m = this.labelPosition, n = e.getBBox(), q = this.chart.rotate, p = a.isNegative, t = this.fontSize;
        ...
        animateColumns: function (a, b) {
            ...
            0 < e && !c.animationPlayed && (c.seqAn ? (a.set.hide(), c.animationArray.push(a),
                e = setTimeout(function () { c.animate.call(c); }, e / (c.end - c.start + 1) * (b - c.start) * 1E3), c.timeOuts.push(e)) : c.animate(a), c.chart.animatable.push(a));
        },
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                m.push(q);
                m.click(function (a) { g.handleGraphEvent(a, "clickGraph"); }).mouseover(function (a) { g.handleGraphEvent(a, "rollOverGraph"); }).mouseout(function (a) {
                    g.handleGraphEvent(a, "rollOutGraph");
                }).touchmove(function (a) { g.chart.handleMouseMove(a); }).touchend(function (a) { g.chart.handleTouchEnd(a); });
                ...
                if (0 < h || 0 < A)
                    if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == q ? (r.push(0), p.push(0)) :
                        ...
                        0 < h && (b = d.polygon(l, p, r, w, h, 1, "#000", 0, a, f), b.pattern(g.pattern, NaN, k.path), d.setCN(k, b, g.bcn + "fill"), m.push(b)), u || void 0 !== z)
                        isNaN(A) && (A = h), u || (u = z), f = d.polygon(l, p, r, u, A, 1, "#000", 0, a, f), d.setCN(k, f, g.bcn + "fill"), d.setCN(k, f, g.bcn + "fill-negative"), f.pattern(g.pattern, NaN, k.path), n.push(f), n.click(function (a) { g.handleGraphEvent(a, "clickGraph"); }).mouseover(function (a) { g.handleGraphEvent(a, "rollOverGraph"); }).mouseout(function (a) { g.handleGraphEvent(a, "rollOutGraph"); }).touchmove(function (a) { g.chart.handleMouseMove(a); }).touchend(function (a) { g.chart.handleTouchEnd(a); });
                g.applyMask(n, m);
            }
        },
        ...
        animateGraphs: function () {
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3),
                c.translate(e, -1E3)), b.animate({ opacity: 1, translate: e + "," + d }, f, h), c.animate({ opacity: 1, translate: e + "," + d }, f, h), a.animatable.push(b));
        },
        animate: function (a) {
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                if (p) {
                    ...
                    if ("serial" == e.type || "gantt" == e.type)
                        if (-.5 >
                            b || b > this.width || c < -h / 2 || c > this.height)
                            p.remove(), p = null;
...
(function () {
    ...
    d.ChartCursor = d.Class({
        ...
        dispatchPanEvent: function () {
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), g = !1;
            ...
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname)
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = h.lastTime, h = h.firstTime, k = Math.round(b / l) + h, b = this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + h, k > b && (k = b), 0 < g && b - k < g && (b = Math.round(k + (b - k) / 2), m = Math.round(g / 2), k = b - m, b += m, m = !0), 0 < e && b - k > e && (b = Math.round(k + (b - k) / 2), m = Math.round(e / 2), k = b - m, b += m, m = !0), b > a && (b =
                        a), b - g < k && (k = b - g), k < h && (k = h), k + g > b && (b = k + g), k != this.startTime || b != this.endTime)
                    ...
                    if (g != this.start || this.end != b)
                        k.startOnAxis && (this.resizingRight && g == b && b++, this.resizingLeft && g == b && (0 < g ? g-- : b = 1)), this.start = g, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start,
...
(function () {
    ...
    d.AmBalloon = d.Class({
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    c.chart_container.appendChild(n);
                    this.textDiv = n;
        ...
        showBalloon: function (a) { if (this.text != a || this.positionChanged)
...
(function () {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        resetAnimation: function () { this.animatable = []; var a = this.graphs; if (a) {
            var b;
            for (b = 0; b < a.length; b++)
...
(function () {
    ...
    d.drop =
        function (a, b, c, d, g, f, h, k) {
            var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, w = -b / 3, z = b / 3;
            0 === c && (w = -w, z = 0);
            180 == c && (z = 0);
            90 == c && (w = 0);
            270 == c && (w = 0, z = -z);
    ...
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
        ...
        359.94 < x && (x = 359.94);
        g >= x && (g = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, y = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * h, D = b + Math.sin((e + g) * u) * f, C = c - Math.cos((e + g) * u) * h, I = b + Math.sin((e + g) * u) * k, u = c - Math.cos((e + g) * u) * w, H = { fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"] }, Q = 0;
        180 < Math.abs(g) && (Q = 1);
        e = a.set();
        var M;
        z && (x = r(10 * x), y =
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n) {
            ...
            for (l = 0; l < b.length; l++)
                isNaN(b[l]) || isNaN(c[l]) ? (e += this.drawSegment(g, p, t), l < b.length - 1 && (e += "L" + b[l + 1] + "," + c[l + 1] + " "), g = []) : g.push({ x: Number(b[l]), y: Number(c[l]) });
            ...
            if (2 < a.length)
                for (var g = 0; g < a.length - 1; g++) {
                    ...
                    0 === g ? (f.push({ x: k.x, y: k.y }), f.push({ x: k.x, y: k.y }),
                        f.push({ x: l.x, y: l.y }), f.push({ x: m.x, y: m.y })) : g >= a.length - 2 ? (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({ x: l.x, y: l.y })) : (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({ x: m.x, y: m.y }));
                    h = [];
                    k = Math.round;
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function () {
            var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;

(function () {
    ...
    e.AmStockChart = e.Class({ construct: function (a) {
            this.type = "stock";
            ...
            a && (this.animationPlayed =
                !1, a.setDefaultPeriod());
        }, validateSize: function () { this.measurePanels(); }, updateDataSets: function () { var a = this.mainDataSet, b = this.dataSets, c; for (c = 0; c < b.length; c++) {
            var d = b[c], d = e.processObject(d, e.DataSet);
            b[c] = d;
        ...
        } !a && e.ifArray(b) && (this.mainDataSet = this.dataSets[0]); this.getSelections(); }, getLastDate: function (a) {
            var b = e.getDate(a, this.dataDateFormat, "fff");
            a = this.categoryAxesSettings.minPeriod;
            var c = e.extractPeriod(a), b = e.changeDate(b, c.period, 1 * c.count, !0).getTime();
            -1 == a.indexOf("fff") && --b;
            return new Date(b);
        }, getFirstDate: function (a) { a = e.getDate(a, this.dataDateFormat, "fff"); var b = e.extractPeriod(this.categoryAxesSettings.minPeriod); return new Date(e.resetDateToMin(a, b.period, 1 * b.count, this.firstDayOfWeek)); }, updateData: function () {
        ...
        }, fixGlue: function () { if (this.glueToTheEnd && this.startDate && this.endDate && this.lastDate) {
            ...
            if (this.mainDataSet) {
                ...
                if (this.mainDataSet.dataParsed && a)
                    return !0;
            }
            return !1;
        }, onDataUpdated: function () { this.isDataParsed() && (this.updatePanelsWithNewData(), this.skipEvents || this.fire({ type: "dataUpdated", chart: this })); }, updateComparingData: function () {
        ...
        }, delayedParseStockData: function (a, b) { var c = this, d = c.categoryAxesSettings; setTimeout(function () { c.parseStockData.call(c, b, d.minPeriod, d.groupToPeriods, c.firstDayOfWeek, c.dataDateFormat); }, c.processTimeout * a); }, parseStockData: function (a, b, c, d, k) {
            var g = this, l = {}, h = a.dataProvider, n = a.categoryField;
            if (n) {
                var f = e.getItemIndex(b, c), m = c.length, q, t = h.length, p, y = {};
                for (q = f; q < m; q++)
                    p = c[q], l[p] = [];
                var v = {}, A = a.fieldMappings, E = A.length;
                for (q =
                    0; q < t; q++) {
                    var B = h[q], D = e.getDate(B[n], k, b), C = D.getTime(), r = {}, z;
                    for (z = 0; z < E; z++)
                        r[A[z].toField] = B[A[z].fromField];
                    for (z = f; z < m; z++) {
                        p = c[z];
                        var u = e.extractPeriod(p), F = u.period, G = u.count, w, x;
                        if (z == f || C >= y[p] || !y[p]) {
                            v[p] = {};
                            v[p].amCategoryIdField = String(e.resetDateToMin(D, F, G, d).getTime());
                            var H;
                            for (H = 0; H < E; H++)
                                u = A[H].toField, w = v[p], null !== r[u] && (x = Number(r[u]), w[u + "Count"] = 0, isNaN(x) || (w[u + "Open"] = x, w[u + "Sum"] = x, w[u + "High"] = x, w[u + "AbsHigh"] = x, w[u + "Low"] = x, w[u + "Close"] = x, w[u + "Count"] = 1, w[u + "Average"] =
                                    x));
                            w.dataContext = B;
                            w.rawData = [];
                            w.rawData.push(B);
                            ...
                            for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++)
                                u = A[p].toField, q == t - 1 && (w[n] = e.newDate(D, b)), null !== r[u] && (x = Number(r[u]), isNaN(x) || (isNaN(w[u + "Low"]) && (w[u + "Low"] = x), x < w[u + "Low"] && (w[u + "Low"] = x), isNaN(w[u + "High"]) && (w[u + "High"] = x), x > w[u + "High"] && (w[u +
            ...
            e.ifArray(a.stockEvents) ? 0 < g.processTimeout ? setTimeout(function () { g.parseEvents.call(g, a, g.panels, g.stockEventsSettings, g.firstDayOfWeek, g, g.dataDateFormat); }, g.processTimeout) :
            ...
            d = a.stockEvents;
            d.sort(function (a, b) { return a.showOnAxis || b.showOnAxis ? (1 == a.showOnAxis) - (1 == b.showOnAxis) : isNaN(a.value) && isNaN(b.value) ? 0 : !isNaN(a.value) - !isNaN(b.value); });
            var l = a.agregatedDataProviders, h = b.length, n, f, m, q, t, p;
            for (n = 0; n < h; n++) {
                p = b[n];
                t = p.graphs;
                m = t.length;
                for (f = 0; f < m; f++)
                    q = t[f], q.customBulletField = "amCustomBullet" + q.id + "_" + p.id,
            ...
            var l = g.period, h = g.count, n = Math.floor(d + (k - d) / 2), f = b[n], m = f[c.categoryField], q = this.dataDateFormat, t = m instanceof Date;
            ...
            if (a >= q && a < l)
                return f;
            if (!(1 >= k - d))
                return a < q ? this.getEventDataItem(a, b, c, d, n, g) : this.getEventDataItem(a, b, c, n, k, g);
        }, createLayout: function () {
            var a = this.div, b, c, d = this.classNamePrefix, e = document.createElement("div");
            ...
            if ("right" == b || "right" == c)
                b = document.createElement("div"), b.className = d + "-right-div", b.style.cssFloat = "right", b.style.styleFloat = "right", b.style.width = "0px", e.appendChild(b), this.rightContainer = b;
        ...
        }, addPanels: function () { this.measurePanels(!0); for (var a = this.panels, b = 0; b < a.length; b++) {
            var c = a[b], c = e.processObject(c, e.StockPanel, this.theme, !0);
            a[b] = c;
            this.addStockPanel(c, b);
        } this.panelsAdded = !0; }, measurePanels: function (a) {
            this.measure();
            var b = this.chartScrollbarSettings, c = this.divRealHeight, d = this.divRealWidth;
            if (this.div) {
            ...
            if (d = a.stockLegend)
                d = e.processObject(d, e.StockLegend, this.theme), d.container = void 0, d.title = a.title, d.marginLeft = c.marginLeft, d.marginRight = c.marginRight, d.verticalGap = 3, d.position = "top", e.copyProperties(this.legendSettings, d), a.addLegend(d, d.divId);
            a.zoomOutText =
                "";
            this.addCursor(a);
        }, enableCursors: function (a) { var b = this.chartCursors, c; for (c = 0; c < b.length; c++)
            b[c].enabled = a; }, updatePanels: function () { var a = this.panels, b; for (b = 0; b < a.length; b++)
            this.updatePanel(a[b]); this.mainDataSet && this.updateGraphs(); this.currentPeriod = void 0; }, updatePanel: function (a) {
            ...
            a.showCategoryAxis ? "top" == b.position ? a.marginTop = c.axisHeight : a.marginBottom = c.axisHeight : (a.categoryAxis.labelsEnabled = !1, a.chartCursor && (a.chartCursor.categoryBalloonEnabled =
                !1));
            var c = a.valueAxes, d = c.length, k;
            ...
            a.listenersAdded = !1;
            a.write(a.panelBox);
        }, zoom: function (a, b) { this.zoomChart(a, b); }, zoomOut: function () { this.zoomChart(this.firstDate, this.lastDate); }, updatePanelsWithNewData: function () {
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (0 < a.dataProvider.length) {
                        ...
                        if (g) {
                            var l = a.agregatedDataProviders[d], h = a.categoryField, n = this.getFirstDate(l[0][h]).getTime();
                            this.getLastDate(l[l.length - 1][h]).getTime() - n <
                                e.getPeriodDuration(g) && (g = d);
                            b.dataProvider = a.agregatedDataProviders[g];
                        }
                        else
                            b.dataProvider = a.agregatedDataProviders[d];
                    }
                    else
                        b.dataProvider = [];
                    g = b.categoryAxis;
            ...
            b && (b.clear(), b.destroy());
            if (a.enabled) {
                var c = this.panelsSettings, d = this.categoryAxesSettings, b = new e.AmSerialChart(this.theme);
                ...
                b.marginTop = 0;
                b.marginBottom = 0;
                var c = d.dateFormats, k = b.categoryAxis;
        ...
        }, handleScrollbarZoom: function (a) { if (this.skipScrollbarEvent)
            ...
            if (a) {
                ...
                c && (d = c.position);
                var c = this.panelsSettings.panelSpacing, k = document.createElement("div");
                this.periodSelectorContainer = k;
                var g = this.leftContainer, l = this.rightContainer, h = this.centerContainer, n = this.panelsContainer, f = a.width + 2 * c + "px";
                switch (a.position) {
                    case "left":
                    ...
                    case "top":
                        ...
                        break;
                    case "bottom": k.style.marginTop = c + "px", "bottom" == d ? h.insertBefore(k, b) : h.appendChild(k);
                }
            ...
            if (a) {
                ...
                this.dssContainer = d;
                var e = this.leftContainer, g = this.rightContainer, l = this.centerContainer, h = this.panelsContainer, c = a.width + 2 * c + "px";
                switch (b) {
                    case "left":
            ...
            if (this.categoryAxesSettings.equalSpacing) {
                ...
                c = new Date(a.start), d = new Date(a.end);
            b.startDate = c;
            b.endDate = d;
            this.handleZoom(b);
            this.handleCursorChange(a);
        }, handleZoom: function (a) { this.zoomChart(a.startDate, a.endDate); }, zoomChart: function (a, b) {
            var c = this;
            a || (a = c.firstDate);
            var d = e.newDate(a), k = c.firstDate, g = c.lastDate, l = c.currentPeriod, h = c.categoryAxesSettings, n = h.minPeriod, f = c.panelsSettings, m = c.periodSelector, q = c.panels, t = c.comparedGraphs, p = c.scrollbarChart, y = c.firstDayOfWeek;
            if (k && g) {
                a || (a = k);
                b || (b = g);
                if (l) {
                ...
                c.currentPeriod = l;
                var n = e.extractPeriod(l), A = e.getPeriodDuration(n.period, n.count);
                ...
                for (k = 0; k < q.length; k++) {
                    ...
                    if (l != h) {
                        ...
                        if (d = g.chartCursor)
                            d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(n.period), g.showCategoryAxis || (d.categoryBalloonEnabled =
                                !1);
                ...
                c.animationPlayed = !0;
                f = e.newDate(b);
                p && c.updateScrollbar && (p.zoomToDates(a, f), c.skipScrollbarEvent = !0, setTimeout(function () { c.resetSkip.call(c); }, 100));
                c.updateScrollbar = !0;
                c.startDate = a;
                c.endDate =
                    b;
                m && m.zoom(a, b);
                c.skipEvents || a.getTime() == c.previousStartDate.getTime() && b.getTime() == c.previousEndDate.getTime() || (m = { type: "zoomed" }, m.startDate = a, m.endDate = b, m.chart = c, m.period = l, c.fire(m), c.previousStartDate = e.newDate(a), c.previousEndDate = e.newDate(b));
            }
            c.eventsHidden && c.showHideEvents(!1);
            c.dispDUpd();
        }, dispDUpd: function () {
            this.skipEvents || (this.chartCreated || (this.chartCreated = !0, this.fire({ type: "init", chart: this })), this.chartRendered || (this.chartRendered = !0, this.fire({ type: "rendered", chart: this })),
                this.fire({ type: "drawn", chart: this }));
            this.animationPlayed = this.chartCreated = !0;
        }, resetSkip: function () { this.skipScrollbarEvent = !1; }, updateGraphs: function () {
            this.getSelections();
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        var f = g[l], f = e.processObject(f, e.StockGraph, this.theme);
                        g[l] = f;
                        ...
                        if (f.comparable) {
                            ...
                            if (f.valueAxis) {
                                ...
                                0 < B && "whenComparing" == c.recalculateToPercents && (f.valueAxis.recalculateToPercents =
                                    !0);
                                p && f.valueAxis && !0 === f.valueAxis.recalculateToPercents && (t = !0);
                                var D;
                                for (D = 0; D < B; D++) {
                                    var C = k[D], r = f.comparedGraphs[C.id];
        ...
        passFields: function (a, b) { for (var c = "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern gap className".split(" "), d = 0; d < c.length; d++) {
            var e = c[d];
            b[e + "Field"] = a[e + "Field"];
        } }, choosePeriod: function (a, b, c) {
            var d = this.categoryAxesSettings, k = d.groupToPeriods, g = k[a], l = k[a + 1], h = e.extractPeriod(g), h = e.getPeriodDuration(h.period, h.count), n = b.getTime(), f = c.getTime(), m = d.maxSeries;
            d.alwaysGroup && g == d.minPeriod && (g = 1 < k.length ? k[1] : k[0]);
            return (f -
                n) / h > m && 0 < m && l ? this.choosePeriod(a + 1, b, c) : g;
        }, getSelections: function () { var a = [], b = this.dataSets, c; for (c = 0; c < b.length; c++) {
            var d = b[c];
            d.compared && a.push(d);
        } this.comparedDataSets = a; b = this.panels; for (c = 0; c < b.length; c++)
            d = b[c], d.hideDrawingIcons && ("never" != d.recalculateToPercents && 0 < a.length ? d.hideDrawingIcons(!0) : d.drawingIconsEnabled && d.hideDrawingIcons(!1)); }, addPanel: function (a) { this.panels.push(a); this.prevPH = void 0; e.removeChart(a); e.addChart(a); }, addPanelAt: function (a, b) {
            this.panels.splice(b, 0, a);
            this.prevPH = void 0;
            e.removeChart(a);
            e.addChart(a);
        }, removePanel: function (a) { var b = this.panels; this.prevPH = void 0; var c; for (c = b.length - 1; 0 <= c; c--)
            b[c] == a && (this.fire({ type: "panelRemoved", panel: a, chart: this }), b.splice(c, 1), a.destroy(), a.clear()); }, validateData: function (a) { var b = this; b.validateDataTO && clearTimeout(b.validateDataTO); b.validateDataTO = setTimeout(function () { b.validateDataReal.call(b, a); }, 100); }, validateDataReal: function (a) {
            a || this.resetDataParsed();
            this.updateDataSets();
            this.mainDataSet.compared =
                !1;
            this.updateData();
            (a = this.dataSetSelector) && a.write(a.div);
        }, resetDataParsed: function () { var a = this.dataSets, b; for (b = 0; b < a.length; b++)
            a[b].dataParsed = !1; }, validateNow: function (a, b) { this.skipDefault = !0; this.chartRendered = !1; this.prevPH = void 0; this.skipEvents = b; this.clear(!0); this.initTO && clearTimeout(this.initTO); a && this.resetDataParsed(); this.write(this.div); }, hideStockEvents: function () { this.showHideEvents(!1); this.eventsHidden = !0; }, showStockEvents: function () {
            this.showHideEvents(!0);
            this.eventsHidden =
                !1;
        }, showHideEvents: function (a) { var b = this.panels, c; for (c = 0; c < b.length; c++) {
            var d = b[c].graphs, e;
            for (e = 0; e < d.length; e++) {
                var g = d[e];
                !0 === a ? g.showCustomBullets(!0) : g.hideCustomBullets(!0);
            }
        } }, invalidateSize: function () { var a = this; clearTimeout(a.validateTO); var b = setTimeout(function () { a.validateNow(); }, 5); a.validateTO = b; }, measure: function () { var a = this.div; if (a) {
            var b = a.offsetWidth, c = a.offsetHeight;
            a.clientHeight && (b = a.clientWidth, c = a.clientHeight);
            this.divRealWidth = b;
            this.divRealHeight = c;
        } }, handleResize: function () {
            var a = this, b = setTimeout(function () { a.validateSizeReal(); }, 150);
            a.initTO = b;
        }, validateSizeReal: function () { this.previousWidth = this.divRealWidth; this.previousHeight = this.divRealHeight; this.measure(); if (this.divRealWidth != this.previousWidth || this.divRealHeight != this.previousHeight)
            0 < this.divRealWidth && 0 < this.divRealHeight && this.fire({ type: "resized", chart: this }), this.divRealHeight != this.previousHeight && this.validateNow(); }, clear: function (a) {
            var b = this.panels, c;
            if (b)
                for (c = 0; c < b.length; c++) {
                    var d = b[c];
...
(function () {
    var e = window.AmCharts;
    e.PeriodSelector = e.Class({ construct: function (a) { this.cname = "PeriodSelector"; this.theme = a; this.createEvents("changed"); this.inputFieldsEnabled = !0; this.position = "bottom"; this.width = 180; this.fromText = "From: "; this.toText = "to: "; this.periodsText = "Zoom: "; this.accessibilityText = "Select a timeframe to show chart data"; this.periods = []; this.inputFieldWidth = 100; this.dateFormat = "DD-MM-YYYY"; this.hideOutOfScopePeriods = !0; e.applyTheme(this, a, this.cname); }, zoom: function (a, b) {
            var c = this.chart;
            ...
            var b = this, c = b.chart, d = c.classNamePrefix;
            a.className = "amChartsPeriodSelector " + d + "-period-selector-div";
            var k = b.width, g = b.position;
            b.width = void 0;
            b.position = void 0;
            ...
            if (b.inputFieldsEnabled) {
                ...
                m.onblur = function (a) { b.handleCalChange(a); };
                e.isNN && m.addEventListener("keypress", function (a) { b.handleCalendarChange.call(b, a); }, !0);
                e.isIE && m.attachEvent("onkeypress", function (a) { b.handleCalendarChange.call(b, a); });
                n.appendChild(m);
                b.startDateField = m;
                if (k)
                    f = b.width - 6 + "px", e.addBr(n);
                else {
                    var f = b.inputFieldWidth + "px", q = document.createTextNode(" ");
                    n.appendChild(q);
                }
                m.style.width =
                    f;
                ...
                a && e.applyStyles(m.style, a.PeriodInputField);
                m.style.textAlign = "center";
                m.onblur = function () { b.handleCalChange(); };
                e.isNN && m.addEventListener("keypress", function (a) { b.handleCalendarChange.call(b, a); }, !0);
        ...
        }, addEventListeners: function (a) { var b = this; e.isNN && a.addEventListener("click", function (a) { b.handlePeriodChange.call(b, a); }, !0); e.isIE && a.attachEvent("onclick", function (a) { b.handlePeriodChange.call(b, a); }); }, getPeriodDates: function () {
            var a = this.periods, b;
            for (b = 0; b < a.length; b++)
                this.selectPeriodButton(a[b], !0);
        }, handleCalendarChange: function (a) { 13 == a.keyCode && this.handleCalChange(a); }, handleCalChange: function (a) { var b = this.dateFormat, c = e.stringToDate(this.startDateField.value, b), b = this.chart.getLastDate(e.stringToDate(this.endDateField.value, b)); try {
        ...
        }, setRanges: function (a, b) { this.firstDate = a; this.lastDate = b; this.getPeriodDates(); }, selectPeriodButton: function (a, b, c) {
            var d = a.button, k = d.count, g = d.period, l = this.chart, h, n, f = this.firstDate, m = this.lastDate, q, t = this.theme;
            ...
            if (!this.skipMark) {
                var a = this.chart, b = this.periods, c = a.startDate.getTime(), d = a.endDate.getTime(), k = this.lastDate.getTime();
                d > k && (d = k);
                k = this.theme;
                this.unselectButtons();
                var g;
                for (g = b.length - 1; 0 <= g; g--) {
                    var l = b[g], h = l.button;
            ...
            this.skipMark =
                !1;
        }, unselectButtons: function () { var a = this.chart, b = this.periods, c, d = this.theme; for (c = b.length - 1; 0 <= c; c--) {
            var k = b[c].button;
            k.className = "amChartsButton " + a.classNamePrefix + "-period-input";
            d && e.applyStyles(k.style, d.PeriodButton);
        } }, setDefaultPeriod: function () { var a = this.periods, b; if (this.chart.chartCreated)
            for (b = 0; b < a.length; b++) {
                var c = a[b];
...
(function () {
    var e = window.AmCharts;
    e.StockPanel = e.Class({ inherits: e.AmSerialChart, construct: function (a) {
            ...
            e.applyTheme(this, a, this.cname);
        }, initChart: function (a) { e.StockPanel.base.initChart.call(this, a); this.drawingIconsEnabled && this.createDrawIcons(); (a = this.chartCursor) && this.listenTo(a, "draw", this.handleDraw); }, addStockGraph: function (a) { this.stockGraphs.push(a); return a; }, handleCursorZoom: function (a) {
            a.start = NaN;
            a.end =
                NaN;
            e.StockPanel.base.handleCursorZoom.call(this, a);
        }, removeStockGraph: function (a) { var b = this.stockGraphs, c; for (c = b.length - 1; 0 <= c; c--)
            b[c] == a && b.splice(c, 1); }, createDrawIcons: function () {
            var a = this, b = a.iconSize, c = a.container, d = a.pathToImages, k = a.realWidth - 2 * b - 1 - a.marginRight, g = e.rect(c, b, b, "#000", .005), l = e.rect(c, b, b, "#000", .005);
            l.translate(b + 1, 0);
            ...
            e.setCN(a, f, "eraser");
            a.eraserButton = f;
            l.mouseup(function () { a.handleEraserClick(); });
        ...
        }, handlePencilClick: function () { var a = !this.drawingEnabled; this.disableDrawing(!a); this.erasingEnabled = !1; var b = this.eraserButtonPushed; b && b.hide(); b = this.pencilButtonPushed; a ? b && b.show() : (b && b.hide(), this.setMouseCursor("auto")); }, disableDrawing: function (a) { this.drawingEnabled = !a; var b = this.chartCursor; this.stockChart && (this.stockChart.enableCursors(a), b && b.enableDrawing(!a)); }, handleEraserClick: function () {
            ...
            this.drawOnAxis = b;
            var c = this.categoryAxis, d = a.initialX, k = a.finalX, g = a.initialY;
            a = a.finalY;
            ...
            this.validateNow();
        }, hideDrawingIcons: function (a) { (this.hideIcons = a) && this.disableDrawing(a); }, handleTrendClick: function (a) { this.erasingEnabled && (a = a.trendLine, this.eraseAll || a.isProtected || this.removeTrendLine(a), this.validateNow()); }, handleWheelReal: function (a, b) {
            ...
            if (!this.wheelBusy && c) {
                ...
                this.mouseWheelZoomEnabled ?
                    b || (d = -1) : b && (d = -1);
                if (d != e)
                    var g = this.mouseX / this.plotAreaWidth, d = d * g, e = e * (1 - g);
                if (c = c.chartScrollbar)
                    c.getPercents(), g = .05 * (c.percentEnd - c.percentStart), .005 > g && (g = .005), 0 > a ? (d = c.percentStart + d * g, e = c.percentEnd + e * g) : (d = c.percentStart - d * g, e = c.percentEnd - e * g), e > d && c.percentZoom(d, e, !0);
            }
        } });
})();
...
(function () {
    var e = window.AmCharts;
    e.ChartCursorSettings = e.Class({ construct: function (a) {
            this.cname = "ChartCursorSettings";
            this.enabled = !0;
            this.bulletsEnabled = this.valueBalloonsEnabled = !1;
            this.graphBulletSize = 1;
            this.onePanelOnly = !1;
            this.categoryBalloonDateFormats = [{ period: "YYYY", format: "YYYY" }, { period: "MM", format: "MMM, YYYY" }, { period: "WW", format: "MMM DD, YYYY" }, { period: "DD", format: "MMM DD, YYYY" }, { period: "hh", format: "JJ:NN" }, { period: "mm", format: "JJ:NN" }, { period: "ss", format: "JJ:NN:SS" }, { period: "fff",
                    format: "JJ:NN:SS" }];
            e.applyTheme(this, a, this.cname);
        }, categoryBalloonDateFormat: function (a) { var b = this.categoryBalloonDateFormats, c, d; for (d = 0; d < b.length; d++)
            b[d].period == a && (c = b[d].format); return c; } });
})();
...
(function () { var e = window.AmCharts; e.getItemIndex = function (a, b) { var c = -1, d; for (d = 0; d < b.length; d++)
    a == b[d] && (c = d); return c; }; e.addBr = function (a) { a.appendChild(document.createElement("br")); }; e.applyStyles = function (a, b) { if (b && a)
    for (var c in a) {
        var d = c, e = b[d];
        if (void 0 !== e)
            try {
...
(function () {
    var e = window.AmCharts;
    e.StockLegend = e.Class({ inherits: e.AmLegend, construct: function (a) { e.StockLegend.base.construct.call(this, a); this.cname = "StockLegend"; this.valueTextComparing = "[[percents.value]]%"; this.valueTextRegular = "[[value]]"; e.applyTheme(this, a, this.cname); }, drawLegend: function () {
            var a = this;
...
(function () {
    var e = window.AmCharts;
    e.DataSetSelector = e.Class({ construct: function (a) { this.cname = "DataSetSelector"; this.theme = a; this.createEvents("dataSetSelected", "dataSetCompared", "dataSetUncompared"); this.position = "left"; this.selectText = "Select:"; this.comboBoxSelectText = "Select..."; this.compareText = "Compare to:"; this.width = 180; this.dataProvider = []; this.listHeight = 150; this.listCheckBoxSize = 14; this.rollOverBackgroundColor = "#b2e1ff"; this.selectedBackgroundColor = "#7fceff"; e.applyTheme(this, a, this.cname); },
        write: function (a) {
            var b = this, c, d = b.theme, k = b.chart;
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                a.appendChild(m);
                e.isNN && m.addEventListener("change", function (a) { b.handleDataSetChange.call(b, a); }, !0);
                e.isIE && m.attachEvent("onchange", function (a) { b.handleDataSetChange.call(b, a); });
                ...
                if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), f = b.listCheckBoxSize, l) {
                    ...
                    for (c = 0; c < g.length; c++)
                        n = g[c], !0 === n.showInCompare && n != b.chart.mainDataSet && (d = document.createElement("div"), d.style.padding = "4px", d.style.position = "relative", d.name = "amCBContainer", d.className = k.classNamePrefix + "-compare-item-div", d.dataSet = n, d.style.height = f + "px", n.compared && (d.style.backgroundColor = b.selectedBackgroundColor), h.appendChild(d), l = document.createElement("div"),
                            l.style.width = f + "px", l.style.height = f + "px", l.style.position = "absolute", l.style.backgroundColor = n.color, d.appendChild(l), l = document.createElement("div"), l.style.width = "100%", l.style.position = "absolute", l.style.left = f + 10 + "px", d.appendChild(l), n = document.createTextNode(n.title), l.style.whiteSpace = "nowrap", l.style.cursor = "default", l.appendChild(n), b.addEventListeners(d));
                    e.addBr(a);
                    e.addBr(a);
                }
                else {
                    ...
                    h && (d.style.width = h);
                    a.appendChild(d);
                    e.isNN && d.addEventListener("change", function (a) { b.handleCBSelect.call(b, a); }, !0);
        ...
        }, handleRollOver: function (a) { a = this.getRealDiv(a); a.dataSet.compared || (a.style.backgroundColor = this.rollOverBackgroundColor); }, handleRollOut: function (a) { a = this.getRealDiv(a); a.dataSet.compared || (a.style.removeProperty && a.style.removeProperty("background-color"), a.style.removeAttribute && a.style.removeAttribute("backgroundColor")); },
        handleCBSelect: function (a) { var b = this.compareCB, c = this.dataProvider, d, e; for (d = 0; d < c.length; d++)
            e = c[d], e.compared && (a = { type: "dataSetUncompared", dataSet: e }), e.compared = !1; c = b.selectedIndex; 0 < c && (e = this.dataProvider[b.options[c].value], e.compared || (a = { type: "dataSetCompared", dataSet: e }), e.compared = !0); b = this.chart; b.validateData(!0); a.chart = b; this.fire(a); }, handleClick: function (a) {
            ...
            a.chart = b;
            this.fire(a);
        }, getRealDiv: function (a) { a || (a = window.event); a = a.currentTarget ? a.currentTarget : a.srcElement; "amCBContainer" == a.parentNode.name && (a = a.parentNode); return a; }, countDataSets: function (a) { var b = this.dataProvider, c = 0, d; for (d = 0; d < b.length; d++)
            !0 === b[d][a] && c++; return c; } });
})();
(function () {
    var e = window.AmCharts;
    e.StackedBullet = e.Class({ construct: function () { this.stackDown = !1; this.mastHeight = 8; this.shapes = []; this.backgroundColors = []; this.backgroundAlphas = []; this.borderAlphas = []; this.borderColors = []; this.colors = []; this.rollOverColors = []; this.showOnAxiss = []; this.values = []; this.showAts = []; this.textColor = "#000000"; this.nextY = 0; this.size = 16; }, parseConfig: function () {
            ...
            b = d.set();
            var k = -1, g = this.stackDown, l = this.graph.valueAxis;
            this.showOnAxis && (this.stackDown = l.reversed ? !0 : !1);
            this.stackDown && (k = 1);
            var h = 0, n = 0, f = 0, m, q = this.fontSize, t = this.mastHeight, p = this.shape, y = this.textColor;
            void 0 !== this.color &&
                (y = this.color);
            void 0 === a && (a = "");
            a = e.fixBrakes(a);
            ...
            switch (p) {
                ...
                case "text":
                    ...
                    d = q + 10;
                    break;
                case "round": v = this.drawCircle(b);
            }
            this.bullets[c] = v;
        ...
        }, drawPin: function (a) { var b = -1; this.stackDown && (b = 1); var c = this.fontSize + 4; return this.drawRealPolygon(a, [0, c / 2, c / 2, -c / 2, -c / 2, 0], [0, b * c / 4, b * (c + c / 4), b * (c + c / 4), b * c / 4, 0]); }, drawSign: function (a) {
            var b = -1;
            this.stackDown && (b = 1);
            var c = this.mastHeight * b, d = this.fontSize / 2 + 2, k = e.line(this.container, [0, 0], [0, c], this.borderColor, this.borderAlpha, 1), g = e.circle(this.container, d, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
            g.translate(0, c + d * b);
            a.push(k);
            a.push(g);
            this.cset.push(a);
            ...
            this.cset.push(a);
            return b;
        }, drawTextBackground: function (a, b) { var c = b.getBBox(), d = -c.width / 2 - 5, e = c.width / 2 + 5, c = -c.height - 12; return this.drawRealPolygon(a, [d, -5, 0, 5, e, e, d, d], [-5, -5, 0, -5, -5, c, c, -5]); }, handleMouseOver: function (a, b) {
            b || this.bullets[a].attr({ fill: this.rollOverColors[a] });
            var c = this.eventObjects[a], d = { type: "rollOverStockEvent", eventObject: c, graph: this.graph, date: this.date }, k = this.bulletConfig.eventDispatcher;
            d.chart = k;
            k.fire(d);
            ...
            var b = { type: "clickStockEvent", eventObject: a, graph: this.graph, date: this.date }, c = this.bulletConfig.eventDispatcher;
            b.chart = c;
            c.fire(b);
            b = a.urlTarget;
            b || (b = c.stockEventsSettings.urlTarget);
            e.getURL(a.url, b);
        }, handleMouseOut: function (a) { this.bullets[a].attr({ fill: this.backgroundColors[a] }); a = { type: "rollOutStockEvent", eventObject: this.eventObjects[a], graph: this.graph, date: this.date }; var b = this.bulletConfig.eventDispatcher; a.chart = b; this.chart.hideBalloonReal(); b.fire(a); } });
})();
